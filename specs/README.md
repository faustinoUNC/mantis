...
| Story | Título | Estado |
|---|---|---|
| [STORY-958](STORY-958.md) | Un técnico rechazado puede volver a enviar la solicitud (el reintento pisa la rechazada, solo si nunca fue aprobado; email de rechazo con link para reintentar) | ✅ done |
