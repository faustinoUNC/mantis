...
| Story | Título | Estado |
|---|---|---|
| [STORY-982](STORY-982.md) | Finanzas gráfico y de un vistazo: 4 stat cards de resumen (por cobrar / por liquidar / cobrado y liquidado del mes), gráfico de barras mensual por tab (recharts, responde a la búsqueda), meses cerrados colapsables (solo el más reciente abierto) y pendientes ordenados por antigüedad — rediseño UX del módulo de Giuliano (`6f2a863`), sin tocar el server layer | ✅ done |
