...
## Tercera tanda (2026-07-09, revisión de Fausti)
- **"Cumplimiento de plazo" → "Se pasaron del plazo":** los que terminan antes o en fecha NO aportan valor al cliente. La métrica ahora **filtra a los que se pasaron** (pct > 0). Color pasa a rampa cálida pura (ámbar→terracota, más intenso = más se pasó, sin el teal de "cumplió"). Leyenda de dos colores → hint de una línea. Tooltip "Tardó X% más de lo que prometió". Estado vacío positivo: "Ningún técnico se pasó del plazo que comprometió". Subtítulo aclara que los que cumplen no se listan.
