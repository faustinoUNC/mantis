...
- [x] **Terminar la obra con avance obligatorio + gastos que justifican el exceso** (2026-07-11, STORY-936, SIN commitear — Fausti revisa) — el técnico no puede terminar la ejecución sin al menos una nota de avance, y si rinde materiales por más de lo presupuestado, el exceso debe estar cubierto por gastos imprevistos con ticket (Σ gastos ≥ exceso; bloqueo UI con montos en vivo + rechazo server). Rendir igual o menos no exige nada; los gastos siguen siendo de carga libre en ejecución. Sin migración. Verificada E2E.
